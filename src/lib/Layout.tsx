...
function TinyWaveFormIcon({
  colors = [],
  ...props
}: { colors?: string[] } & JSX.IntrinsicElements['svg']) {
  return (
...
function ApplePodcastIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg aria-hidden="true" viewBox="0 0 32 32" {...props}>
      <path
        fillRule="evenodd"
...
function OvercastIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg aria-hidden="true" viewBox="0 0 32 32" {...props}>
...
function RSSIcon(props: JSX.IntrinsicElements['svg']) {
  return (
    <svg aria-hidden="true" viewBox="0 0 32 32" {...props}>
      <path
        fillRule="evenodd"
...
function PersonIcon(props: JSX.IntrinsicElements['svg']) {
  return (
...
function AboutSection(props: JSX.IntrinsicElements['section']) {
...
export function Layout({ children }: React.PropsWithChildren) {
  ...
  return (
    <div className="grid h-full min-h-screen grid-cols-12 bg-slate-900">
      <header className="col-span-3 grid grid-cols-12 bg-slate-900">
        ...
        <div className="relative z-10 col-span-11 mx-auto flex h-full flex-col pt-10 md:max-w-2xl lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-800/70 lg:pt-12">
          <div className="px-12">
            <Link
              href="/"
